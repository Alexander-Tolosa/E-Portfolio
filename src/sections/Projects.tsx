...
export function Projects() {
  ...
  return (
    <section id="projects" className="py-24 relative overflow-hidden bg-brand-dark/30">
      ...
      <div className="absolute top-10 left-10 w-96 h-96 bg-accent-blue/5 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-10 right-10 w-96 h-96 bg-accent-purple/5 rounded-full blur-[120px] pointer-events-none" />

      <div className="max-w-7xl mx-auto px-6">
        {/* Section Heading */}
        <div className="mb-16 text-center md:text-left">
          <span className="text-xs font-semibold uppercase tracking-wider text-accent-cyan px-3 py-1 rounded-full bg-accent-cyan/10">
            Portfolio
          </span>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white mt-4">
            Featured Projects & Case Studies
          </h2>
          <div className="h-1 w-20 bg-accent-cyan mt-4 mx-auto md:mx-0 rounded" />
        </div>
            ...
            <button
              ...
              className={`text-xs font-semibold px-5 py-2.5 rounded-xl border transition-all cursor-pointer ${
                filterCategory === category
                  ? "bg-gradient-to-r from-accent-cyan to-accent-blue border-transparent text-white shadow-md shadow-accent-cyan/20"
